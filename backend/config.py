...
class BaseConfig:
    ...
    UNIVERSE_CRYPTO_SIZE = int(os.getenv("UNIVERSE_CRYPTO_SIZE", "100"))
    UNIVERSE_CRYPTO_LOOKBACK_DAYS = int(
        os.getenv("UNIVERSE_CRYPTO_LOOKBACK_DAYS", "90")
    )
    UNIVERSE_CRYPTO_REQUEST_INTERVAL_SECONDS = float(
        os.getenv("UNIVERSE_CRYPTO_REQUEST_INTERVAL_SECONDS", "13")
    )
    UNIVERSE_CRYPTO_DATE_MAX_ATTEMPTS = int(
        os.getenv("UNIVERSE_CRYPTO_DATE_MAX_ATTEMPTS", "2")
    )
    UNIVERSE_MAX_CANDIDATE_AGE_SECONDS = int(
        os.getenv("UNIVERSE_MAX_CANDIDATE_AGE_SECONDS", "3600")
    )
